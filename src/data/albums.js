export default [{
  ...
  songs: [
    ...
    songs: [
      ...
      { title: 'Orange', duration: '103.96', audioSrc: '/assets/music/green.mp3' },
      { title: 'Yellow', duration: '268.45', audioSrc: '/assets/music/red.mp3' },
      { title: 'Purple', duration: '153.14', audioSrc: '/assets/music/pink.mp3' },
      { title: 'Magenta', duration: '374.22', audioSrc: '/assets/music/magenta.mp3' }
    ]
}];
